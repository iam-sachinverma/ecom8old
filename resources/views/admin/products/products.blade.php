                ...
                <table id="products" class="table table-bordered table-striped">
                  ...
                  @foreach($products  as $product) 
                    <tr>
                        ...
                        <td>
                        <a title="Add/Edit Product" href="{{ url('admin/add-edit-product/'.$product->id) }}"><i class="fas fa-edit"></i></a> &nbsp;
                        <a title="Add/Edit Attributes" href="{{ url('admin/add-attributes/'.$product->id) }}"><i class="fab fa-adn"></i></a> &nbsp;
                        <a title="Add/Edit Filters" href="{{ url('admin/add-edit-filter/'.$product->id) }}"><i class="fas fa-filter"></i></a> &nbsp;
                        <a title="Add Images" href="{{ url('admin/add-images/'.$product->id) }}"><i class="fas fa-file-image"></i></a> &nbsp;
                        <a title="Delete Product" href="javascript:void(0)" class="confirmDelete" record="product" recordid="{{ $product->id }}" <?php /*href="{{ url('admin/delete-product/'.$product->id) }}" */ ?>>&nbsp;<i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
                  @endforeach  
                  </tbody>  
