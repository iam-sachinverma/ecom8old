              ...
              <div class="col-12 col-sm-6">
                <div class="form-group">
                  <label for="image">Banner Image</label>
                    ...
                    Recommended Image Size: Width:1600px, Height:400px
                    @if(!empty($banner['image']))
                    <div><img style="width:250px; margin-top:15px;" src="{{ asset('images/banner_images/'.$banner['image']) }}">          
                    &nbsp;<a class="confirmDelete" href="javascript:void(0)" record="banner-image" recordid="{{ $banner['id'] }}">Delete Image</a></div>
                    @endif
                </div>
              </div>   
              <div class="col-12 col-sm-6">
