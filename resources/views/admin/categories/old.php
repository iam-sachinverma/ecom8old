          ...
          <div class="card-body">
            <div class="row">
              ...
              <div class="col-md-6">
                ...
                <!-- /.form-group -->
                <div class="form-group">
                  <label for="category_image">Catgeory Image</label>
                  <div class="input-group">
                      ...
                      @if(!empty($categorydata['category_image']))
                        <div><img style="width:80px; margin-top:9px;" src="{{ asset('images/category_images/'.$categorydata['category_image']) }}">
            ...
            <div class="row">
              <div class="col-12 col-sm-6">
                ...
                <div class="form-group">
                  ...
                  <textarea class="form-control" id="description" name="description" rows="3" placeholder="Enter ...">@if(!empty($categorydata['description'])) {{ $categorydata['description'] }} @else {{ old('description') }} @endif
                  </textarea>
                </div>
