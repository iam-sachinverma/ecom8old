                ...
                <table id="categories" class="table table-bordered table-striped">
                  ...
                  @endif   
                    <tr>
                        ...
                        <a href="javascript:void(0)" class="confirmDelete" record="category" recordid="{{ $category->id }}" <?php /*href="{{ url('admin/delete-category/'.$category->id) }}" */ ?>>&nbsp;<i class="fas fa-trash-alt"></i></a>
                        </td>
                    </tr>
                  @endforeach  
                  </tbody>  
